...
export function RootLayout() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Demo mode notice */}
      <div className="w-full border-b bg-amber-50 dark:bg-amber-950/40">
        <div className="container mx-auto px-4 py-2 flex items-center gap-2 text-xs sm:text-sm text-amber-800 dark:text-amber-200">
          <Info className="size-4 shrink-0" />
          <span>
            Demo mode: you&apos;re viewing sample facilities and schedules. No live database is connected, so bookings and reservations here won&apos;t be saved.
          </span>
        </div>
      </div>
